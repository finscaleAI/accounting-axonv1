package org.muellners.finscale.accounting.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(org.muellners.finscale.accounting.repository..*)" +
            " || within(org.muellners.finscale.accounting.service..*)" +
            " || within(org.muellners.finscale.accounting.web.rest..*)"
    )
