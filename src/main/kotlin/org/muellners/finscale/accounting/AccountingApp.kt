...
import org.muellners.finscale.accounting.client.OAuth2InterceptedFeignConfiguration
import org.muellners.finscale.accounting.config.ApplicationProperties
...
class AccountingApp(private val env: Environment) {
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<AccountingApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(AccountingApp::class.java)
